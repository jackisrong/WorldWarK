...
public class WorldWarK extends JPanel implements Runnable {
	...
	if (score <= 2500) {
		...
		case 7:
		    for (int i = 0; i < 150; i += 50) {
			enemyLeft = new Enemy(0 - i * 2, 100 + i / 2, 64, 64, 3, 3, 50, 1, 75, 1000 + i * 2);
			enemyRight = new Enemy(450 + i * 2, 300 - i / 2, 64, 64, -3, 3, 50, 1, 75, 1000 + i * 2);
			enemyLeft.setReverse(true);
			enemyRight.setReverse(true);
			objects.add(enemyLeft);
			objects.add(enemyRight);
		...
		case 8:
		    for (int i = 0; i < 150; i += 50) {
			enemyLeft = new Enemy(50 + i, 0 - i, 64, 64, -3, 7, 50, 4, 75, 1000 + i * 2);
			enemyRight = new Enemy(385 - i, 0 - i, 64, 64, 3, 7, 50, 4, 75, 1000 + i * 2);
			enemyLeft.setReverse(true);
			enemyRight.setReverse(true);
			objects.add(enemyLeft);
			objects.add(enemyRight);
