...
public class EnemyFactory {
	...
	switch (choice) {
	    case 1:
		for (int i = 0; i < 150; i += 50) {
		    enemies.add(new Enemy(50 + i, 0 - i, 64, 64, 0, 7, 100, 4, 75, 1000 + i * 2));
		    enemies.add(new Enemy(385 - i, 0 - i, 64, 64, 0, 7, 100, 4, 75, 1000 + i * 2));
		}
		break;
	    case 2:
		for (int i = 0; i <= 100; i++) {
		    if (i == 0 || i == 50 || i == 100) {
			enemies.add(new Enemy(50 - i * 2, 250, 64, 64, 7, 0, 100, 1, 75, 1000 + i * 2));
			enemies.add(new Enemy(450 + i * 2, 150, 64, 64, -7, 0, 100, 1, 75, 1000 + i * 2));
		    }
		}
		break;
	    case 3:
	    ...
	    case 5:
		for (int i = 0; i < 150; i += 50) {
		    enemies.add(new Enemy(-200 + i, 32 + i, 64, 64, 5, 0, 100, 1, 75, 1000 + i * 2));
		    enemies.add(new Enemy(700 - i, 296 - i, 64, 64, -5, 0, 100, 1, 75, 1000 + i * 2));
		}
		break;
	    case 6:
		for (int i = 0; i < 150; i += 50) {
		    enemies.add(new Enemy(-200 + i, -i, 64, 64, 5, 7, 100, 1, 75, 1000 + i * 2));
		    enemies.add(new Enemy(700 - i, -i, 64, 64, -5, 7, 100, 1, 75, 1000 + i * 2));
		}
		break;
	    case 7:
		for (int i = 0; i < 150; i += 50) {
	...
	switch (choice) {
	    case 1:
		for (int i = 0; i < 150; i += 50) {
		    enemies.add(new Enemy(50 + i, 0 - i, 64, 64, 0, 10, 150, 5, 100, 1000 + i * 2));
		    enemies.add(new Enemy(385 - i, 0 - i, 64, 64, 0, 10, 150, 5, 100, 1000 + i * 2));
		}
		break;
	    case 2:
		for (int i = 0; i <= 100; i++) {
		    if (i == 0 || i == 50 || i == 100) {
			enemies.add(new Enemy(50 - i * 2, 250, 64, 64, 10, 0, 150, 2, 100, 1000 + i * 2));
			enemies.add(new Enemy(450 + i * 2, 150, 64, 64, -10, 0, 150, 2, 100, 1000 + i * 2));
		    }
		}
		break;
	    case 3:
	    ...
	    case 5:
		for (int i = 0; i < 150; i += 50) {
		    enemies.add(new Enemy(-200 + i, 32 + i, 64, 64, 7, 0, 150, 2, 100, 1000 + i * 2));
		    enemies.add(new Enemy(700 - i, 296 - i, 64, 64, -7, 0, 150, 2, 100, 1000 + i * 2));
		}
		break;
	    case 6:
		for (int i = 0; i < 150; i += 50) {
		    enemies.add(new Enemy(-200 + i, -i, 64, 64, 7, 10, 150, 2, 50, 1000 + i * 2));
		    enemies.add(new Enemy(700 - i, -i, 64, 64, -7, 10, 150, 2, 50, 1000 + i * 2));
		}
		break;
	    case 7:
		for (int i = 0; i < 150; i += 50) {
